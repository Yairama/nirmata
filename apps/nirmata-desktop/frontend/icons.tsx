...
export type IconName =
  | "arrow-left" | "arrow-down" | "arrow-up" | "book" | "chevron-left"
  | "chevron-right" | "clock" | "download" | "flask" | "globe" | "history"
  | "home" | "layers" | "more" | "search" | "sparkles" | "trash" | "x";
...
const paths: Record<IconName, React.ReactNode> = {
  ...
  sparkles: <><path d="m12 3 1.2 3.8L17 8l-3.8 1.2L12 13l-1.2-3.8L7 8l3.8-1.2L12 3Z" /><path d="m5 14 .8 2.2L8 17l-2.2.8L5 20l-.8-2.2L2 17l2.2-.8L5 14ZM19 12l.7 1.3L21 14l-1.3.7L19 16l-.7-1.3L17 14l1.3-.7L19 12Z" /></>,
